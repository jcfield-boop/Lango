...
esp_err_t tool_registry_init(void)
{
    ...
    mimi_tool_t rf = {
        .name = "read_file",
        .description = "Read a file from SPIFFS storage. Path must start with /lfs/.",
        .input_schema_json =
            "{\"type\":\"object\","
            "\"properties\":{\"path\":{\"type\":\"string\",\"description\":\"Absolute path starting with /lfs/\"}},"
            "\"required\":[\"path\"]}",
    ...
    mimi_tool_t ld = {
        ...
        .input_schema_json =
            "{\"type\":\"object\","
            "\"properties\":{\"prefix\":{\"type\":\"string\",\"description\":\"Optional path prefix filter, e.g. /lfs/memory/\"}},"
            "\"required\":[]}",
    ...
    mimi_tool_t se = {
        .name = "send_email",
        .description = "Send an email via Gmail SMTP using credentials stored in /lfs/config/SERVICES.md. "
    ...
    mimi_tool_t sf = {
        ...
        .input_schema_json =
            ...
            "\"prefix\":{\"type\":\"string\",\"description\":\"Optional path prefix to limit search, e.g. /lfs/memory/\"}"
            "},"
            "\"required\":[\"pattern\"]}",
    ...
    mimi_tool_t hr = {
        .name = "http_request",
        .description = "Make an HTTPS GET or POST request to an external API. Use this to call services like email (Resend), SMS, or any REST API. Read credentials from /lfs/config/SERVICES.md first.",
        .input_schema_json =
            "{\"type\":\"object\","
            "\"properties\":{"
