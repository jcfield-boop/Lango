...
8. `send_email` with:
   ...
   - body: **target 600-900 words** of substantive content, sections in this order:
     ...
     - 📅 **This Week** — pull from MEMORY.md and USER.md. List pending TODOs, upcoming events/meetings, anything James asked to remember, any focus areas from his profile that warrant a status callout. If genuinely nothing is queued, say so in one line — but check both files thoroughly first; they are the most useful section when there IS content.
